...
public class GUIObjects extends JComponent {
    ...
    public GUIObjects(Component comp, String type, int self) {
        this(comp, new ResizableBorder(8), type, self);

    }

    public GUIObjects(Component comp, ResizableBorder border, String type, int self) {
        this.comp = comp;
        this.self = self;
        this.type = type;
        ...
        public void mouseClicked(MouseEvent me) {
            if (me.getClickCount() == 2 && me.getButton() == MouseEvent.BUTTON1) {
                if (comp instanceof JLabel) {
                    ...
                    LabelEditor options = new LabelEditor(textBox.getText(), self, type);
